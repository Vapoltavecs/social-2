  ...
  return video ? (
    <div className={classes.video}>
      <div className={classes.video__container}>
        <img src={video.video} alt="preview" className={classes.video__image} />
        <div className={classes.video__content}>
          <div className={classes.video__content_header}>
            ...
            <div className={classes.video__raiting}>
              <div className={classes.video__raiting_item}>
                <img src={like} alt="like" className={classes.video__raiting_img} />
                {video.likes}
              </div>
              <div className={classes.video__raiting_item}>
                <img src={like} alt="dislike" className={classes.video__raiting_img}  style={{transform: 'rotate(180deg)'}}/>
                {video.dislikes}
              </div>
            </div>
          </div>
          ...
          <div className={classes.video__comments}>
            <div className={classes.video__comments_title}>Комментарии:</div>
            <div className={classes.video__comments_comments}>
